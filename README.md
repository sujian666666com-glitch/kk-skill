...
| ai-image-to-code | 基于 UI 截图/设计图生成 HTML 或 React 组件的说明型 skill | 2026-05-28 latest 批次收录 |
| aries-holiday-weekday | 基于国务院节假日通知判断工作日/节假日/调休日的查询 skill | 2026-05-28 latest 批次收录 |
...
| project-review-council | 20 角色对抗式项目评审/复盘/Go-NoGo 决议说明型 skill，附阶段化 workflow、评分表和决议模板 | 2026-06-26 latest 批次收录 |
